...
#for I in 1 2 3 ; do
	for STRIDE in 12288 24576 1228800 ; do
		for THINK in 100 500 1000 1500; do
			...
			gcc -Wall -g ./fadvise-readAhead.c -std=gnu99 -lrt -o fadvise-readAhead.fadvise.stride${STRIDE}.think${THINK}  -DFADVISE2  -DTIME_THINK=$THINK -DSTRIDE=$STRIDE
			gcc -Wall -g ./fadvise-readAhead.c -std=gnu99 -lrt -o fadvise-readAhead.withoutfadvise.stride${STRIDE}.think${THINK}  -DTIME_THINK=$THINK -DSTRIDE=$STRIDE
