...
--plugin $FEIGN_DEV_PLUGIN_PATH/helper/posix-chroot-open-path/libfeign_chroot-open-path.so \
--plugin $FEIGN_DEV_PLUGIN_PATH/helper/posix-precreator/libfeign_posix-precreator.so \
